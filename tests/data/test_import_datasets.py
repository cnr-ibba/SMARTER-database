...
class DatasetsNotExistTest(MongoMockMixin, unittest.TestCase):
    def setUp(self):
        self.runner = CliRunner()
        self.input_file = DATA_DIR / "test-dataset_not_exists.csv"
    ...
    def test_import_datasets(self, my_raw_dir, my_working_dir):
        ...
        with tempfile.TemporaryDirectory() as tmpdirname:
            ...
            self.assertNotEqual(0, result.exit_code, msg=result.exception)
